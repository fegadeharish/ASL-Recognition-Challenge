...
def load_data(container_path='D:/Python_Examples/Introduction to DataCamp Projects/ASL Recognition with Deep Learning/asl_alphabet_train', folders=['A', 'B', 'C'], size=2000, test_split=0.2, seed=0):
    """
